...
export function buildSystemPrompt(): string {
  return [
    ...
    '- As you work, mark each item started, then done, using `update_task`. When you genuinely need owner input and cannot continue, mark it blocked and supply a short reason — only in that case.',
